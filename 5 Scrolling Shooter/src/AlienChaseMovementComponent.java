...
class AlienChaseMovementComponent implements MovementComponent {
    ...
    //Gives this class the ability to tell the game engine to spawn a laser
    ...
    public boolean move(long fps, Transform t, Transform playerTransform) {
        ...
        final int TAKE_SHOT = 0; //Arbitrary Value
        ...
        //Prevent the ship locking in too accurately
        ...
        if (Math.abs(location.x - playerLocation.x) <= mSeeingDistance){
            //Use a cast do get rid of unnecessary floats that make ship judder
        ...
        //Shoot if the alien is within a ships height above, below or in line with
