...
class GameObjectFactory {
    ...
    GameObject create(ObjectSpec spec){
        ...
        //Configure the object size relative to the screen size
        PointF objectSize = new PointF(mScreenSize.x / spec.getScale().x,
                mScreenSize.y / spec.getScale().y);

        //Set the location to somewhere on the screen
        ...
        for (int i = 0; i < numComponents; i++){
            //System.out.println(spec.getComponents()[i]);
            switch (spec.getComponents()[i]){
                ...
                case "BackgroundGraphicsComponent":
                    object.setGraphics(new BackgroundGraphicsComponent(), mContext,
                            spec, objectSize);
                    break;
                ...
                case "AlienChaseMovementComponent":
                    object.setMovement(new AlienChaseMovementComponent(
                ...
                default:
                    ...
                    System.out.println("---------------------------------------------------------");
                    System.out.println("Fehler bei " + spec.getComponents()[i]);
                    System.out.println("---------------------------------------------------------");
                    break;
            }
        }
