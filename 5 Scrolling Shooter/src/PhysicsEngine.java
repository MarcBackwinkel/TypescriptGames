...
class PhysicsEngine {
    ...
    boolean update(long fps, ArrayList<GameObject> objects, GameState gs,
    ...
    boolean detectCollisions(GameState mGameState, ArrayList<GameObject> objects,
                             SoundEngine se, ParticleSystem ps){
        ...
        for (GameObject go1 : objects){
            if (go1.checkActive()){
                //The object is active so worth checking
