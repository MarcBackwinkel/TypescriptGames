    ...
    private void detectCollisions(){
        ...
        for (int i = 0; i < mNumBullets; i++){
            if (RectF.intersects(mBullets[i].getRect(), mBob.getRect())){
                ...
                //This flags that a hit occured so that the draw method "knows" as well
                mHit = true;
                ...
                if (mNumHits == mShield){
                    ...
                    startGame();
                    //for-loop will not continue as the call to startGame() sets
                    //all parameters back to initial values
                }
            }
        }
    }
