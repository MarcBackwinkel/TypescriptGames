...
class GameEngine extends SurfaceView implements Runnable, GameEngineBroadcaster,
    ...
    private CopyOnWriteArrayList<InputObserver> inputObservers =
    ...
    public GameEngine(Context context, Point size) {
        super(context);
        //Prepare the bitmap store and sound engine - both Singletons!!!
        BitmapStore bs = BitmapStore.getInstance(context);
        SoundEngine se = SoundEngine.getInstance(context);

        //Initialize all the significant classes that make the engine work
