...
class InanimateBlockGraphicsComponent implements GraphicsComponent {
    ...
    public void initialize(Context context, GameObjectSpec spec, PointF objectSize,
        ...
        BitmapStore.addBitmap(context, mBitmapName, objectSize, pixelsPerMetre,
                false);
    }
    ...
    public void draw(Canvas canvas, Paint paint, Transform t, Camera cam) {
        ...
        //use the camera to translate the real world coordinates relative to the
        //player into screen coordinates
