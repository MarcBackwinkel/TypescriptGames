...
class GameState {
    ...
    //EngineController to enable GameState to reinitialize the game / level
    //directly
    ...
    void startNewGame(){
        //Don't want to be handling objects while clearing ArrayList and
        //filling it up
        stopEverything();
    ...
    private void endGame(){
        stopEverything();
        int totalTime = ((mCoinsAvailable - coinsCollected) * 10)
                + getCurrentTime();
    ...
    void stopEverything(){
        //Stop everything except the thread
        mPaused = true;
        mGameOver = true;
        mDrawing = false;
    }
